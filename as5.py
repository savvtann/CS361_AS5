# -*- coding: utf-8 -*-
"""
Title: CS361 Assignment 5

Author: Savannah Tanner
    
Description: My MVP project will take a user's input to create a trackable
goal. They can add updates, restart the goal, and add notes to their updates. 

"""

#open document 
print("Welcome to your personal Goal Tracker! Here you may update, create, and track your goals. \n")
mvp_doc = open(r'C:\Users\roset\OneDrive\Desktop\mvp_doc.txt','a+')


goal_statement = "Goal: \n"


with open(r'C:\Users\roset\OneDrive\Desktop\mvp_doc.txt') as f:
